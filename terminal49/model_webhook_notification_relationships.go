...
type WebhookNotificationRelationships struct {
	Webhook WebhookNotificationRelationshipsWebhook `json:"webhook"`
	ReferenceObject WebhookNotificationRelationshipsReferenceObject `json:"reference_object,omitempty"`
}
