...
*/
func (a *ContainersApiService) GetContainers(ctx _context.Context, localVarOptionals *GetContainersOpts) (InlineResponse2006, *_nethttp.Response, error) {
	var (
...
*/
func (a *ContainersApiService) GetContainersId(ctx _context.Context, id string) (InlineResponse2007, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
